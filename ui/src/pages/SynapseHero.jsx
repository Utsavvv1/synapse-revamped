...
export default function SynapseHero() {
  return (
    <div className="flex-1 flex flex-col justify-center w-full min-w-0">
      ...
      <button className="my-6 group flex items-center bg-synapse-accent rounded-full text-synapse-dark font-medium body-text hover:bg-synapse-accent/90 transition-all duration-300 w-fit px-4 py-2 md:px-5 md:py-2.5 lg:px-6 lg:py-3 gap-2 text-xs md:text-sm lg:text-base glow-accent hover:scale-105">
