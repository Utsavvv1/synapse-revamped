...
export default function SynapseActions() {
  return (
    <div className="flex gap-2 md:gap-2.5 lg:gap-3">
      ...
      <button className="group flex items-center justify-center glass-card-dark rounded-full text-synapse-accent font-medium body-text flex-1 button-hover transition-all duration-300 px-3 py-1.5 md:px-4 md:py-2 lg:px-5 lg:py-2.5 gap-1 md:gap-1.5 text-xs sm:text-sm whitespace-nowrap" style={{ backgroundColor: 'hsl(var(--secondarycolor))' }}>
